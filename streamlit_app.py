...
#config page
st.title("Medical Research Analyst")
st.markdown("Generate blogs about any topic using AI Agents.")
...
with st.sidebar:
    ...
    max_tokens = st.slider("max_tokens", 400, 1200, 750)
    ...
    with st.expander("How to use"):
        st.markdown("""
                    ...
                    2. Select the settings as needed
                    3. Click 'Generate Content'
                    4. Wait for the AI to generate the blog
                    5. Download the result as a .md file
                    6. Hooray!!! a creative blog is created! Enjoy. """
...
def generate_content(topic):
    ...
    content_writer = Agent(
        ...
        role = "Content-Writer",
        goal = "transform research findings taken from the senior research analyst into engaging blog posts while maintaining accuracy ",
...
#Main content area
if generate_button:
    with st.spinner('Generating content... takes a moment.'):
        try:
